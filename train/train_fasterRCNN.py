...
if __name__ == "__main__":
    ...
    model1_path_best = 'models\\faster_RCNN_dogface_dataset1_80epochs_best.pth'
    model1_path_last = 'models\\faster_RCNN_dogface_dataset1_80epochs_last.pth'

    model2_path_best = 'models\\faster_RCNN_dogface_dataset2_80epochs_best.pth'
    model2_path_last = 'models\\faster_RCNN_dogface_dataset2_80epochs_last.pth'

    csv_model1 = 'faster_RCNN_dogface_dataset1_80epochs_statistics.csv'
    csv_model2 = 'faster_RCNN_dogface_dataset2_80epochs_statistics.csv'
