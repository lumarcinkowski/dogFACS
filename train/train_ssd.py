...
class DogFaceDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        for obj in root.findall('object'):
            ...
            labels.append(1)  # Assuming 1 class for dog face
...
def get_model(num_classes, size):
...
def train(dataset, val_dataset, num_epochs, path_best, path_last, csv_path):
    ...
    model = get_model(num_classes=2, size=300)
    model.to(device)
...
if __name__ == "__main__":
    ...
    model1_path_best = 'models\\ssd_dogface_dataset1_80epochs_best.pth'
    model1_path_last = 'models\\ssd_dogface_dataset1_80epochs_last.pth'

    model2_path_best = 'models\\ssd_dogface_dataset2_80epochs_best.pth'
    model2_path_last = 'models\\ssd_dogface_dataset2_80epochs_last.pth'

    csv_model1 = 'ssd_dogface_dataset1_80epochs_statistics.csv'
    csv_model2 = 'ssd_dogface_dataset2_80epochs_statistics.csv'
